import { ChatHeader, ChatHeadersResponse, ChatMessage, ChatMessages, GetChatMessagesResponse } from '@mp/api/chat/util';
...
export class ChatRepository {
    ...
    async addChatMessage(sender: string, receiver: string, timeStamp: string, payload: string) {
        ...
        await senderRef.set(message1);
        await recieveRef.set(message1);
